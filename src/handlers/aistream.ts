        ...
        onFinish: async ({ text, sources, totalUsage }) => {
            ...
            const tokenCost =
                (((noCacheInput || 0) * 0.2 +
                    ...
                    10000) /
                1_000_000;
            const toolCost = (webSearchTriggered * 10.0 * 100 * 10000) / 1000;
            ...
            const cachedRatio =
                cacheReadInput !== undefined && noCacheInput !== undefined
                    ? Math.round(
                          (cacheReadInput / (cacheReadInput + noCacheInput)) *
                              10000,
                      ) / 100
                    : 0;
            console.log(
